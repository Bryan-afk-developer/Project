...
(1, 5), -- Rosas todo el año
(2, 5),
(3, 5),
(4, 2), -- Girasoles verano
(5, 1), -- Lirios primavera
(5, 2),
(6, 5), -- Orquídeas todo el año
(7, 1), -- Margaritas primavera
(7, 2),
(8, 1), -- Tulipanes primavera
(9, 2), -- Lavanda verano
(10, 5) -- Rosas amarillas todo el año
ON CONFLICT DO NOTHING;
...
-- Check setup (run these after to verify)
-- SELECT COUNT(*) as user_count FROM users;
-- SELECT COUNT(*) as flower_count FROM flowers;
-- SELECT COUNT(*) as category_count FROM categories;
-- SELECT * FROM flower_details LIMIT 5;
